class Solution {
public:
    // TC-> Ni bata sakte depends on seq to seq
    vector<vector<string>> findSequences(string beginWord, string endWord, vector<string>& wordList) {
        ...
        while (!q.empty())
        {
            ...
            if (word == endWord)
            {
                ...
                // or it is the same size as that of ans[0] element  i.e the minimum element
            ...
            {   
                ...
                for (char c = 'a'; c <= 'z'; c++)
                {
                    ...
                    { 
                        ...
                        vec.pop_back(); // why pop back because same koi aur bhi to ho sakta isis level pe
                    }
                }
                word[i] = original;
            }
